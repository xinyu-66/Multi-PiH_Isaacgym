...
table_start_pose.p = gymapi.Vec3(0.0, 2.0, 0.0)
table_start_pose.r = gymapi.Quat(0.0, 0.0, 0.0, 1.0)

# Define start pose for table stand
table_stand_start_pose = gymapi.Transform()
table_stand_start_pose.p = gymapi.Vec3(0.0, 2.15, 0.0)
table_stand_start_pose.r = gymapi.Quat(0.0, 0.0, 0.0, 1.0)

table_opts = gymapi.AssetOptions()
table_asset = gym.create_box(sim, 1.2, 0.1, 1.2, table_opts)
table_stand_asset = gym.create_box(sim, 0.2, 0.2, 0.2, table_opts)
...
for i in range(num_envs):
    ...
    table_stand_actor = gym.create_actor(env, table_stand_asset, table_stand_start_pose, "table_stand",
                                                      i, 1, 0)
...
for i in range(num_envs):
    ...
    # take care of the y and z
    camera_position = gymapi.Vec3(0, 4, 2)
    camera_target = gymapi.Vec3(0, 1.3, 0)
